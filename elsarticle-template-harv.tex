...
\documentclass[nopreprintline,5p,times,twocolumn,authoryear]{elsarticle}
...
% \usepackage[section]{placeins}  % place figures in the section they are called.
\usepackage{xcolor}  % textcolor{color}{text}
...
\newpage
\input{./tex/_Supplementary_Material}
