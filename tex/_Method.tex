...
\end{aligned}
\end{equation}
To derive the last line of \eqnref{eq:LB} we leverage on the \textit{Jensen's inequality} and collect the result into a new expectation term and in the Kullback-Leibler divergence term ($\kl$).
