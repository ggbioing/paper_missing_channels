...
The experimental results on real medical imaging datasets (\tabref{tab:features}, \tabref{tab:classifier}) show the clear improvement of our MT-MCVAE method with respect to the MCVAE, that inspired our work.
...
In our experiments we found no significant differences between the EmbraceNet and our MT-MCVAE \tabrefp{tab:classifier_mtl_nl},
