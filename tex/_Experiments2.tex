...
The purpose of this experiment is to investigate the generalization performance of our model when tested on datasets not used for its training.
...
The purpose of this experiment is to validate the benchmark results obtained in the synthetic experiments, this time on real data.
