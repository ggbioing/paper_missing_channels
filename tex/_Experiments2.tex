...
For the non-linear experiments we choose hidden dimension as the mean value between the input features and latent dimension (32 features), rounded towards the nearest integer
...
No significant difference (t-test, alpha level $0.05$) also were recorded between the EmbraceNet and MT-MCVAE models for any given architecture depth level.
