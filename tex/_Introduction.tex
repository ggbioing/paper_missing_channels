...
The Multi-Channel Variational Autoencoder (MCVAE) \citep{Antelmi2019} has exactly this structure \figrefp{fig:architecture}, although it was proposed as a Single Task learning method.
