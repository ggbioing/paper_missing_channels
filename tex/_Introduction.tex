...
%
Thanks to these actions, the method here proposed allows to learn a joint model for all the subjects without discarding any information \figrefp{fig:model}.
